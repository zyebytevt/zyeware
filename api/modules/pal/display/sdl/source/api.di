// D import file generated from 'modules/pal/display/sdl/source/api.d'
...
package(zyeware.pal.display.sdl_opengl)
{
	...
	extern (C) static nothrow void logFunctionCallback(void* userdata, int category, SDL_LogPriority priority, const char* message);
