...
public static:
    ...
    void function(in Matrix4f projectionMatrix, in Matrix4f viewMatrix) begin;
    ...
    void function(in Rect2f dimensions, in Vector2f position, in Vector2f scale, in Color modulate = Color.white,
        in Texture2D texture = null, in Rect2f region = Rect2f(0, 0, 1, 1)) drawRect;
    ...
    ///     texture = The texture to use. If `null`, draws a blank rectangle.
    ///     region = The region of the rectangle to use. Has no effect if no texture is supplied.
    void function(in Rect2f dimensions, in Vector2f position, in Vector2f scale, float rotation, in Color modulate = Vector4f(1),
        in Texture2D texture = null, in Rect2f region = Rect2f(0, 0, 1, 1)) drawRect;
    ...
    ///     texture = The texture to use. If `null`, draws a blank rectangle.
    ///     region = The region of the rectangle to use. Has no effect if no texture is supplied.
    void function(in Rect2f dimensions, in Matrix4f transform, in Color modulate = Vector4f(1), in Texture2D texture = null,
        in Rect2f region = Rect2f(0, 0, 1, 1)) drawRect;
    ...
    void function(in dstring text, in Font font, in Vector2f position, in Color modulate = Color.white,
        ubyte alignment = Font.Alignment.left | Font.Alignment.top) drawText;
}