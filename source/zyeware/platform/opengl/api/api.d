...
module zyeware.platform.opengl.api.api;
...
import zyeware.platform.opengl.api.types;
import zyeware.platform.opengl.api.utils;
...
NativeHandle createMesh(in Vertex3d[] vertices, in uint[] indices)
{
    ...
    glVertexAttribPointer(0, 3, GL_FLOAT, GL_FALSE, Vertex3d.sizeof,
        cast(void*) Vertex3d.position.offsetof);
    // vertex normals
    glEnableVertexAttribArray(1);
    glVertexAttribPointer(1, 3, GL_FLOAT, GL_FALSE, Vertex3d.sizeof,
        cast(void*) Vertex3d.normal.offsetof);
    // vertex texture coords
    glEnableVertexAttribArray(2);
    glVertexAttribPointer(2, 2, GL_FLOAT, GL_FALSE, Vertex3d.sizeof,
        cast(void*) Vertex3d.uv.offsetof);
    // vertex modulate
    glEnableVertexAttribArray(3);
    glVertexAttribPointer(3, 4, GL_FLOAT, GL_FALSE, Vertex3d.sizeof,
        cast(void*) Vertex3d.modulate.offsetof);
