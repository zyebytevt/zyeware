...
module zyeware.subsystems.graphics.shader;
...
public:
    this(ShaderProperties properties)
    {
        ...
        mNativeHandle = GraphicsSubsystem.callbacks.createShader(properties);
    }

    ~this()
    {
        GraphicsSubsystem.callbacks.freeShader(mNativeHandle);
    }
