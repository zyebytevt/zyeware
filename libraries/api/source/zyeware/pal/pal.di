	...
	private static
	{
		...
		package(zyeware.pal) static
		{
			...
			package(zyeware) static
			{
				...
				public static
				{
					pragma (inline, true)nothrow ref const(GraphicsDriver) graphics()
					{
						return sGraphics;
					}
					pragma (inline, true)nothrow ref const(DisplayDriver) display()
					{
						return sDisplay;
					}
					pragma (inline, true)nothrow ref const(AudioDriver) audio()
					{
						return sAudio;
					}
				}
