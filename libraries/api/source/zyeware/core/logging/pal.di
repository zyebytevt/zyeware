// D import file generated from 'source/zyeware/core/logging/pal.d'
module zyeware.core.logging.pal;
...
private
{
	...
	package(zyeware)
	{
		void initPalLogger(LogLevel level);
		package(zyeware) pragma (inline, true)nothrow
		{
