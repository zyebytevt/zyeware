...
__gshared public Logger logClient;__gshared package(zyeware)  {
...
void flush();pragma(inline, true)  {

void fatal(dstring message) nothrow;

void error(dstring message) nothrow;

void warning(dstring message) nothrow;

void info(dstring message) nothrow;

void debug_(dstring message) nothrow;

void verbose(dstring message) nothrow;
